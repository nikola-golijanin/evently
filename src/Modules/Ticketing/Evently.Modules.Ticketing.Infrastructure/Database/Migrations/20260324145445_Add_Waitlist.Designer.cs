...
namespace Evently.Modules.Ticketing.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260324145445_Add_Waitlist")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Evently.Modules.Ticketing.Domain.Events.WaitlistEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("EventId")
                        .HasDatabaseName("ix_waitlist_entries_event_id");

                    b.HasIndex("TicketTypeId", "CustomerId")
                        .IsUnique()
                        .HasDatabaseName("ix_waitlist_entries_ticket_type_id_customer_id")
                        .HasFilter("status IN ('Waiting', 'Offered')");

                    b.ToTable("waitlist_entries", "ticketing");
                });
            ...
            modelBuilder.Entity("Evently.Modules.Ticketing.Domain.Events.WaitlistEntry", b =>
                {
                    ...
                    b.HasOne("Evently.Modules.Ticketing.Domain.Events.TicketType", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_waitlist_entries_ticket_types_ticket_type_id");
                });
