...
# Run with: ./create-feature-issues.sh

set -e

REPO="nikola-golijanin/evently"

echo "Creating GitHub issues for domain feature requests..."
...
echo ""
echo "Creating GitHub issues for technical feature requests..."
...
echo ""
echo "✅ All 25 GitHub issues created successfully!"
echo ""
echo "Summary:"
echo "- 13 domain feature requests (FR-001 to FR-013)"
echo "- 12 technical feature requests (TFR-001 to TFR-012)"
echo ""
echo "All issues labeled as 'enhancement'"
